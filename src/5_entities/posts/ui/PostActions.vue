<template>
  ...
  <div class="actions">
    ...
    <button v-if="openComments" class="comments-btn">
      <RouterLink :to="`/${id}`">Open comments</RouterLink>
    </button>
...
type TProps = Pick<TPost, 'reactions' | 'tags' | 'id' | 'userReaction'> & { openComments?: boolean }
